...
(function () {
  ...
  function switchLQIP(img) {
    ...
    if (img.hasAttribute(ATTR_DATA_SRC)) {
      var $img = $(img);
      var dataSrc = $img.attr(ATTR_DATA_SRC);
  ...
  function postAgeBanner() {
    // Assign the target node containing the HTML message to a variable
    var postBanner = document.getElementById('post-age-banner');

    // Read the contents of the 'div' containing the posted date
    var postDate = Number(document.getElementById('posted-date').innerHTML);

    // Read the contents of the 'div' containing the post's last update date
    var updatedDate = Number(document.getElementById('updated-date').innerHTML);

    // Read the contents of the 'div' containing the post's last update date
    var ageMonths = Number(document.getElementById('age-months').innerHTML);
    ...
    if (postAgeMonths > ageMonths) {
      ...
      postBanner.textContent = "This post is ".concat(postAgeMonths, " months old. Some information may be outdated or inaccurate. If any updates are required please let us know.");
    }
  }
